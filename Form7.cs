...
namespace prj2
{
  public partial class Form7 : Form
  {
    ...
    int _r2 = 20;                  // 半徑，直徑
    private Balls[] _balls = new Balls[10];   // 10 顆球的陣列
    ...
    private void Form2_Load(object sender, EventArgs e)
    {
      //lblName.Text = "歡迎━" + _user.Name;
            lblName.Text = "歡迎━" + "Hugo";

            _g = pnlTable.CreateGraphics();     // 繪圖裝置 初始化

      // 實作 9 顆球
      for (int i = 1; i < 10; i++)
        _balls[i] = new Balls(200, i * (_r2 + 10) + 90, Color.FromArgb(255, (i * 100) % 256, (i * 50) % 256, (i * 25) % 256), i);

      // 0號球(母球)， 白色，放右邊中間
      _balls[0] = new Balls(600, 230, Color.FromArgb(255, 255, 255, 255), 0);
    ...
    #region method
    private void hit(Balls b0, Balls b1)
    {
      // b1 hit  b0  速度快的撞慢的
      if (b0._spd < b1._spd)
      {
        Balls t = b0;     //  交換球，讓速度快的球成為 b0
        b0 = b1;
        b1 = t;
      }
    ...
    private void hit_speed(Balls b0, Balls b1)  //b0 碰撞 b1(b1是靜止的)
    {
    ...
    private void pullBack(Balls b0, Balls b1)
    {
    ...
    private void ball_Line(Balls b0, Balls bx, Pen p)
    {
      double x1 = b0._x;
